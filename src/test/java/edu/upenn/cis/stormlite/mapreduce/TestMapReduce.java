...
public class TestMapReduce {
    ...
    static void createSampleMapReduce(Config config) {
        ...
        config.put("jobClass", "edu.upenn.cis.stormlite.mapreduce.GroupWords");
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ***** NOTE: This class is just an example code describing how to instantiate the workers,
        //             create a new job and send it to them. This code should help you to get started
        //             on the MasterServlet and WorkerMain.
        //             There are some hard-coded values here - make sure you understand the code before
        //             copy-pasting!

        Config config = new Config();
        
        // Complete list of workers, comma-delimited
        // *** NOTE: This value is hard-coded here, but this list will be decided based on 
