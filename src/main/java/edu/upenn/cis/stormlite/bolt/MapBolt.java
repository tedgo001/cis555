...
public class MapBolt implements IRichBolt {
    ...
    public void prepare(Map<String,String> stormConf, 
        ...
        int spoutExecutors = Integer.valueOf(stormConf.get("spoutExecutors"));
        ...
        neededVotesToComplete = spoutExecutors + spoutExecutors * (numOfWorkers - 1);
    ...
    public synchronized void execute(Tuple input) {
    	if (!input.isEndOfStream()) {
    		...
    		log.debug("Processing EOS from " + input.getInputExecutor());
    		//TODO: make sure emitEndOfStram is working correctly 
