...
public class RobotsTxtInfo {
	...
	public boolean crawlForHost (String dir) {
	    boolean generalNotallowed = (getDisallowedLinks("*") != null) && (getDisallowedLinks("*").contains(dir));
	    
        boolean specificNotallowed = (getDisallowedLinks("cis455crawler") != null) && (getDisallowedLinks("cis455crawler").contains(dir));
        
        boolean specificAllowed = (getAllowedLinks("cis455crawler") != null) && (getAllowedLinks("cis455crawler").contains(dir));
            
        return (specificAllowed || !(generalNotallowed || specificNotallowed));
	}
